...
const TransactionPage = () => {
    ...
    const fetchApartment = async (building) => {
        setBuilding(building.buildingName);
        setBuildingID(building._id);
        const response = await axios.get(`https://bkland.onrender.com/apartments/building/${building._id}`);
    ...
    <>
        ...
        <Container maxW='5xl' h="auto" p="0" marginTop="100px">
            ...
            {apartmentList.map((apartment, index) => (
                apartment.apartmentStatus === 'Đã thuê' || apartment.apartmentStatus === 'Đã đặt cọc' || apartment.apartmentStatus === 'Đã mua' ? (
