...
function ProjectTypes() {
  ...
  const handleCreateProjectType = async () => {
    try {
      await axios.post('https://bkland.onrender.com/projectTypes', form);
  ...
  const handleUpdateProjectType = async () => {
    try {
      await axios.put(`https://bkland.onrender.com/projectTypes/${selectedProjectType._id}`, form);
  ...
  const handleDeleteProjectType = async (id) => {
    try {
      await axios.delete(`https://bkland.onrender.com/projectTypes/${id}`);
